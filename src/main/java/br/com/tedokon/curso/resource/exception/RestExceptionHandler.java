package br.com.tedokon.curso.resource.exception;

import br.com.tedokon.curso.domain.DetalheErro;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> serverException(RuntimeException ex, WebRequest request) {
        ...
        // httpheaders ca becalho e depois
    }

    // a prtir dessa variavel recupera erro
    private String getPath(WebRequest request) {

        return ((ServletWebRequest) request).getRequest().getRequestURI();
    }

    // recupera erro lancado
